...
namespace Equal.CRUD.IDao
{
    ...
    public interface IRelatedSelectDaoBase<T, U> : ISelectDaoBase<T, U> where T : DomainBase<U>
    {
        ...
        /// <param name="orderPropertyColl">排序条件</param>
        /// <returns>查询结果</returns>
        IList<T> SelectRelated(string relatedDomain, string relatedDomainId, ICondition condition = null, NameValueCollection orderPropertyColl = null);
        ...
        /// <param name="condition">查询条件</param>
        /// <returns>查询数量结果</returns>
        int SelectRelatedCount(string relatedDomain, IList<string> relatedDomainIdList, ICondition condition = null);
        ...
        /// <param name="orderPropertyColl">排序条件</param>
        /// <returns>查询结果</returns>
        IList<T> SelectRelatedByPage(int startRecordIndex, int pageSize, string relatedDomain, ICondition condition = null, NameValueCollection orderPropertyColl = null);
