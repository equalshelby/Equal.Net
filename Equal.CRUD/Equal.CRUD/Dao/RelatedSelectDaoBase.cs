...
namespace Equal.CRUD.Dao
{
    ...
    public abstract class RelatedSelectDaoBase<T, U> : SelectDaoBase<T, U>, IRelatedSelectDaoBase<T, U> where T : RelatedDomainBase<U>
    {
        ...
        /// <param name="relatedDomainIdFlag">是否加载关联领域对象Id（默认False）</param>
        ...
        public IList<T> SelectRelated(string relatedDomain, ICondition condition = null, NameValueCollection orderPropertyColl = null)
        {
        ...
        /// </summary>
        /// <param name="relatedDomain">关联领域对象</param>
        /// <param name="relatedDomainId">关联领域对象Id,若Id为空，则返回无子项集合,new List(）</param>
        /// <param name="condition">查询条件</param>
        /// <param name="orderPropertyColl">排序条件</param>
        /// <returns>查询结果</returns>
        ...
        public IList<T> SelectRelated(string relatedDomain, IList<string> relatedDomainIdList, ICondition condition = null, NameValueCollection orderPropertyColl = null)
        {
            ...
            return Select(CreateRelatedConditionHashtable(condition, relatedDomain, false, string.Empty, relatedDomainIdList),
                orderPropertyColl);
        }
        ...
        /// <param name="orderPropertyColl">排序条件</param>
        /// <returns>查询结果</returns>
        public IList<T> SelectRelatedByPage(int startRecordIndex, int pageSize, string relatedDomain, ICondition condition = null, NameValueCollection orderPropertyColl = null)
        {
            return SelectByPage(startRecordIndex, pageSize
                , CreateRelatedConditionHashtable(condition, relatedDomain), orderPropertyColl);
        }
        ...
        /// <param name="orderPropertyColl">排序条件</param>
        /// <returns>查询结果</returns>
        public IList<T> SelectRelatedByPage(int startRecordIndex, int pageSize, string relatedDomain, string relatedDomainId, ICondition condition = null, NameValueCollection orderPropertyColl = null)
        {
            return SelectByPage(startRecordIndex, pageSize
                , CreateRelatedConditionHashtable(condition, relatedDomain, true, relatedDomainId), orderPropertyColl);
        }
        ...
        /// <param name="orderPropertyColl">排序条件</param>
        /// <returns>查询结果</returns>
        public IList<T> SelectRelatedByPage(int startRecordIndex, int pageSize, string relatedDomain, IList<string> relatedDomainIdList, ICondition condition = null, NameValueCollection orderPropertyColl = null)
        {
            if (relatedDomainIdList == null || relatedDomainIdList.Count == 0)
                return new List<T>();

            return SelectByPage(startRecordIndex, pageSize
                , CreateRelatedConditionHashtable(condition, relatedDomain, false, string.Empty, relatedDomainIdList), orderPropertyColl);
        }
